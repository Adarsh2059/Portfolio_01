...
const projectsData = [
  {
    id: "medibridge",
    title: "MediBridge Healthcare Platform",
    subtitle: "Doctor Scheduling & AI Consultation Suite",
    summary: "Full-stack healthcare scheduling and follow-up platform featuring concurrency slot holds, double-booking prevention, Gemini AI pre-visit assessments, and resilient Google Calendar sync.",
    tech: ["React.js", "Node.js", "Express.js", "MongoDB Atlas", "Google Gemini API", "Google Calendar API", "JWT", "Vite"],
    problem: "Healthcare appointment systems suffer from severe double-booking race conditions during simultaneous user checkouts, clinical context gaps prior to doctor visits, and failures caused by tight coupling to external third-party APIs.",
    approach: "Built an availability engine featuring a 10-minute temporary TTL slot-hold mechanism backed by MongoDB compound uniqueness constraints. Integrated Google Gemini for structured pre-visit symptom evaluation and post-visit plain-English summaries, while decoupling Google Calendar OAuth and SMTP notification queues.",
    architecture: "React Vite SPA -> Express REST API -> MongoDB Atlas (authoritative source of truth) with Google Calendar OAuth 2.0 and Gemini API workers running non-blocking background tasks.",
    challenges: "Eliminating concurrency collisions when multiple users select identical appointment slots simultaneously, and safeguarding core database transactions if external Google Calendar or email servers experience downtime.",
    learned: "Mastered distributed state consistency patterns, defensive schema design with compound uniqueness indexes, non-diagnostic AI prompting constraints, and resilient external microservice failure-isolation architectures.",
    github: "https://github.com/Adarsh2059/MediBridge",
    live: "https://medi-bridge-eight.vercel.app",
  },
  {
    id: "blogcraft",
    title: "BlogCraft Platform",
    subtitle: "Modern Content Creation & Publishing Platform",
    summary: "A full-stack blogging platform that enables authenticated users to create, edit, manage, and publish rich blog content with centralized state management.",
    tech: ["React.js", "Redux Toolkit", "Tailwind CSS", "Appwrite", "React Router"],
    problem: "Traditional blogging platforms suffer from bloated client bundles, complex backend setup overhead, and fragmented state synchronization between draft editors and live feeds.",
    approach: "Engineered a responsive React single-page application communicating with Appwrite backend authentication and database services. Utilized Redux Toolkit for centralized global state and React Router for structured client-side navigation.",
    architecture: "React Frontend -> Redux Toolkit State Slice -> Appwrite Cloud BaaS for real-time document storage, media asset hosting, and secure user sessions.",
    challenges: "Handling real-time rich-text authoring states, role-based editing permissions, and optimizing media storage workflows.",
    learned: "Solidified expertise in Redux Toolkit state slices, BaaS integration patterns, and responsive UI system architecture with Tailwind CSS.",
    github: "https://github.com/Adarsh2059/BlogCraft",
    live: null,
  },
  {
    id: "attendance",
